...
export default function MetaAdsSetupGuide() {
  ...
  return (
    <Accordion defaultExpandedKeys={["meta-ads-guide"]}>
      <AccordionItem
        key="meta-ads-guide"
        aria-label="Facebook App 설정 가이드"
        title={
          <div className="flex items-center gap-2">
            <span>🔧</span>
            <span className="font-medium">Facebook App 설정 가이드</span>
          </div>
        }
      >
          ...
          <CardBody className="space-y-4">
            <div className="space-y-3">
              <p className="text-sm text-gray-700">
                &ldquo;URL을 읽어들일 수 없습니다&rdquo; 오류를 해결하려면
                Facebook App 설정에서 다음 항목들을 확인하세요:
              </p>
