...
-- Description: 완전한 통합 스키마 - 중복 제거 및 누락 보완
-- =====================================================

-- =====================================================
-- EXTENSIONS (Required)
-- =====================================================
-- Note: Supabase 대시보드에서 다음 확장 기능을 활성화해야 합니다:
-- - pg_cron (스케줄 작업용)
-- - pg_net (HTTP 요청용)
...
-- pg_net을 통한 Edge Function 호출 함수
...
-- =====================================================
-- CRON JOBS (using pg_cron)
-- =====================================================

-- OAuth 토큰 갱신 작업 - 매 시간 실행
...
-- Google Ads 전체 동기화 작업 - 매일 오전 2시 실행
SELECT cron.schedule(
